...
def bf_af_3(SCREEN, scale, gdf_bckgrnd, build_small, build_big, build_base, SYMBO_PARAM, train, sport, vegetation, water, commune, roads_base, road):
    ...
    build_small.plot(ax = ax2, color = SYMBO_PARAM['residential_col'])
    build_big.plot(ax= ax2, color = SYMBO_PARAM['residential_col'])   
    ...
    vegetation.plot(ax=ax2, color = SYMBO_PARAM['vegetation_col'])
        
    water.plot(ax=ax1, color = SYMBO_PARAM['water_col'])
    water.plot(ax=ax2, color = SYMBO_PARAM['water_col'])
        
    commune.plot(ax=ax1, facecolor = 'None', edgecolor = SYMBO_PARAM['communes_col'], linewidth = SYMBO_PARAM['communes_width'],linestyle=(0,(5,10)))
    commune.plot(ax=ax2, facecolor = 'None', edgecolor = SYMBO_PARAM['communes_col'], linewidth = SYMBO_PARAM['communes_width'],linestyle=(0,(5,10)))
